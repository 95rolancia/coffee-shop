...
export class Product extends BaseComponent<HTMLElement> implements ClickContainer {
  ...
  constructor(id: string, name: string, imageUrl: string, price: string) {
    ...
    const imageElement = this.element.querySelector('.product__img')! as HTMLImageElement;
    imageElement.src = imageUrl;

    const nameElement = this.element.querySelector('.product__name')! as HTMLHeadingElement;
    nameElement.textContent = name;

    const priceElement = this.element.querySelector('.product__price')! as HTMLDivElement;
